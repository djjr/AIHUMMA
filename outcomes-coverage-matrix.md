...
| Cluster | Total Code Assignments | Avg per Course |
|---------|----------------------|----------------|
| **TL** Technical Literacy | 114 | 1.75 |
| **CH** Critical & Humanistic Analysis | 103 | 1.58 |
| **EV** Ethics & Values | 64 | 0.98 |
| **SD** Societal & Domain Applications | 51 | 0.78 |
| **RM** Research & Analytical Methods | 36 | 0.55 |
| **GP** Governance & Policy | 32 | 0.49 |
...
## Tech ↔ Humanistic Distribution

| Scale | Label | Count | % |
|-------|-------|-------|---|
| 1/5 | Highly Technical | 8 | 12% |
| 2/5 | Mostly Technical | 9 | 14% |
| 3/5 | Balanced | 16 | 25% |
...
## Code-by-Code Coverage

### Cluster TL: Technical Literacy

| Code | Description | Courses | % | Assessment |
|------|-------------|---------|---|------------|
| TL-01 | Explain core ML model types conceptually | 24 | 37% | ✅ Well-covered |
| TL-03 | Implement ML workflows in Python | 17 | 26% | ✅ Well-covered |
| TL-04 | Explain LLM architecture and training | 17 | 26% | ✅ Well-covered |
| TL-06 | Distinguish AI paradigms and capabilities | 17 | 26% | ✅ Well-covered |
| TL-07 | Evaluate AI system performance and failure modes | 16 | 25% | ✅ Well-covered |
| TL-05 | Apply mathematical foundations to ML | 12 | 18% | ✅ Moderate |
| TL-02 | Interpret technical AI documentation as argument | 11 | 17% | ⚠️ Moderate — strategically important for AIHUMMA |

**AIHUMMA note:** TL-02 — reading model cards and capability evaluations *as arguments rather than facts* — is underemphasized across the catalog despite being central to the AIHUMMA-F1 foundation course vision. Most courses either teach technical implementation (TL-03) or humanistic critique (CH-02) but don't inhabit the specific middle space of reading technical policy artifacts critically. This is an AIHUMMA signature skill.
...
| Code | Description | Courses | % | Assessment |
|------|-------------|---------|---|------------|
| CH-05 | Evaluate claims about AI consciousness/intelligence | 45 | 69% | ✅ Very well-covered — a baseline assumption |
| CH-02 | Analyze AI discourse as rhetorical construct | 21 | 32% | ✅ Moderate-good |
| CH-04 | Critique AI in cultural forms (film, theatre, fiction) | 16 | 25% | ✅ Appropriately targeted (16 courses after refinement) |
| CH-01 | Situate AI in intellectual/political history | 11 | 17% | ⚠️ Moderate — important for AIHUMMA foundation |
| CH-06 | Analyze AI through feminist/postcolonial/critical race lens | 6 | 9% | ⚠️ Sparse — important for equity framing |
| CH-03 | Apply humanistic methods (ethnography, close reading) to AI | 4 | 6% | 🔴 Rare — AIHUMMA must own this explicitly |

**AIHUMMA note:** CH-05 (questions of AI consciousness and intelligence) is nearly universal — this is the philosophical water the whole curriculum swims in. AIHUMMA does not need to build this; it can be assumed as background. The genuine gap is CH-03: rigorous deployment of humanistic *methods* as analytical tools for studying AI phenomena. Only four courses in the catalog teach ethnographic, discourse-analytic, or close-reading approaches applied specifically to AI. This is a key AIHUMMA differentiator. CH-04 now sits at a realistic 25% — the courses that actually engage with AI in film, theatre, and fiction rather than mentioning societal implications broadly.
...
| Code | Description | Courses | % | Assessment |
|------|-------------|---------|---|------------|
| EV-01 | Apply ethical frameworks to AI decisions | 24 | 37% | ✅ Well-covered |
| EV-02 | Identify and analyze algorithmic bias | 12 | 18% | ✅ Moderate |
| EV-04 | Analyze ethics in high-stakes domains | 12 | 18% | ✅ Moderate |
| EV-03 | Evaluate responsible AI instruments | 10 | 15% | ⚠️ Moderate |
| EV-06 | Assess privacy/consent/data rights implications | 5 | 8% | ⚠️ Sparse |
| EV-05 | Distinguish procedural vs. structural ethics critique | 1 | 2% | 🔴 Nearly absent — AIHUMMA must own this |

**AIHUMMA note:** EV-05 is the sharpest ethics gap in the entire taxonomy. Only one course explicitly addresses the difference between procedural ethics (impact assessments, checklists) and structural critique (the system is the problem, ethics discourse is being weaponized). This is the Timnit Gebru / AI Now critique — "ethics washing." A humanities-trained policy student who can make this distinction fluently is doing something very different from one who learned to fill out an ethics checklist. AIHUMMA's F3 course should make this a central, named learning outcome.
...
| Code | Description | Courses | % | Assessment |
|------|-------------|---------|---|------------|
| RM-02 | Design/conduct computational or quantitative research | 13 | 20% | ✅ Moderate (biased toward technical courses) |
| RM-03 | Critically evaluate academic/policy research | 10 | 15% | ✅ Moderate |
| RM-04 | Synthesize evidence into well-supported arguments | 9 | 14% | ⚠️ Moderate |
...
| Code | Description | Courses | % | Assessment |
|------|-------------|---------|---|------------|
| CW-01 | Produce policy genre writing for decision-makers | 7 | 11% | ⚠️ Sparse |
| CW-03 | Translate technical AI concepts for lay audiences | 5 | 8% | ⚠️ Sparse |
| CW-02 | Write data-driven narratives for general audiences | 1 | 2% | 🔴 Nearly absent (only the journalism course) |
...
| Code | Description | Courses | % | Assessment |
|------|-------------|---------|---|------------|
| HI-01 | Apply human-centered design to AI systems | 13 | 20% | ✅ Moderate (Engineering courses) |
| HI-02 | Design for AI explainability and user trust | 7 | 11% | ⚠️ Moderate — concentrated in CS/Engineering |
| HI-05 | Assess emerging human-AI modalities (BCI, agentic) | 3 | 5% | 🔴 Rare |
...
|----------|------|---------|-----------|----------------|
| ⭐⭐⭐ | EV-05 | Distinguish procedural vs. structural ethics critique | 1 course | F3: Ethics, Values, and AI |
| ⭐⭐⭐ | RM-01 | Design/conduct qualitative research for AI governance | 1 course | A2: Research Methods |
| ⭐⭐⭐ | GP-03 | Use historical tech governance analogies | 2 courses | F2: Institutions and Governance |
| ⭐⭐⭐ | CW-01 | Produce policy genre writing for AI decision-makers | 7 courses | F4: Writing for Policy |
| ⭐⭐⭐ | GP-05 | Read technical AI safety through a policy lens | 3 courses | A3: Frontier AI Risk & Governance |
| ⭐⭐ | TL-02 | Interpret AI technical docs as arguments | 11 courses | F1: How AI Systems Work |
| ⭐⭐ | CH-03 | Apply humanistic methods rigorously to AI phenomena | 4 courses | A2: Research Methods |
| ⭐⭐ | GP-06 | International AI competition and governance | 2 courses | A1: Comparative AI Regulation |
| ⭐⭐ | CW-05 | Use GenAI to enhance research/writing practice | 0 courses | All courses (embedded) |
